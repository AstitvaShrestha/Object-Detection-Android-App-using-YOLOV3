...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    BaseLoaderCallback baseLoaderCallback; //allows us to recieve frames from camera
    ...
    protected void onResume() {
        ...
        if (!OpenCVLoader.initDebug()){
            Toast.makeText(getApplicationContext(),"Theres's a problem", Toast.LENGTH_SHORT).show();
        }
